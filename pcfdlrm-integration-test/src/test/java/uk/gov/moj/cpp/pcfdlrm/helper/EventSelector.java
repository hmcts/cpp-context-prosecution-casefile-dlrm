...
public class EventSelector {
    ...
    public static final String MIGRATED_CASE_FILE_RECEIVED = "pcfdlrm.events.migrated-case-file-received";
    public static final String MIGRATED_CASE_FILE_PROCESSED = "pcfdlrm.events.migrated-case-file-processed";;
