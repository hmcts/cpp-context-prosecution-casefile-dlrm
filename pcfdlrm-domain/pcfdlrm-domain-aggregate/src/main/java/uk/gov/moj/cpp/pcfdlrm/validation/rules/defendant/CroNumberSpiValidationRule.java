...
public class CroNumberSpiValidationRule implements ValidationRule<DefendantWithReferenceData, ReferenceDataQueryService> {
    ...
    private static final Pattern CRO_NUMBER_FORMAT = Pattern.compile(Constants.CRO_NUMBER_REGEX_SPI.getValue());
    ...
    public ValidationResult validate(final DefendantWithReferenceData defendantWithReferenceData, final ReferenceDataQueryService referenceDataQueryService) {
        ...
        return (CRO_NUMBER_FORMAT.matcher(croNumber).matches()) ? ValidationResult.VALID :
