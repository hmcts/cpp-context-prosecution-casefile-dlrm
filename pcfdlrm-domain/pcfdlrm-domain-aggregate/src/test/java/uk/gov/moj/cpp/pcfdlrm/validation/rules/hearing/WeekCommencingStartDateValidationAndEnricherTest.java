...
class WeekCommencingStartDateValidationAndEnricherTest {
    ...
    public void shouldReturnEmptyListWhenDateOfHearingIsInFuture() {
        when(migratedHearingWithReferenceData.getMigratedHearing().getWeekCommencingDate().getStartDate()).thenReturn(DATE_OF_HEARING);

        final Optional<Problem> optionalProblem = new WeekCommencingStartDateValidationAndEnricher().validate(migratedHearingWithReferenceData, referenceDataQueryService)
    ...
    public  void shouldBevalidWhenNoDOHButWC(){
        when(migratedHearingWithReferenceData.getMigratedHearing().getWeekCommencingDate().getStartDate()).thenReturn(null);
    ...
    public  void shouldBevalidWhenDOHEmpty(){
        when(migratedHearingWithReferenceData.getMigratedHearing().getWeekCommencingDate().getStartDate()).thenReturn("");
    ...
    public void shouldReturnProblemWhenDefendantDateOfBirthIsInFuture() {
        ...
        when(migratedHearingWithReferenceData.getMigratedHearing().getWeekCommencingDate().getStartDate()).thenReturn(PAST_DATE_OF_HEARING);
