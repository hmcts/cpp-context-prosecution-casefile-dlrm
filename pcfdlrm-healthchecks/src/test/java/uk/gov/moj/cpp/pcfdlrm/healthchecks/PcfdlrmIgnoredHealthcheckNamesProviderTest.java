package uk.gov.moj.cpp.pcfdlrm.healthchecks;
...
public class PcfdlrmIgnoredHealthcheckNamesProviderTest {

    @InjectMocks
    private PcfdlrmIgnoredHealthcheckNamesProvider ignoredHealthcheckNamesProvider;

    @Test
    public void shouldIgnoreFileStoreAndJobStoreHealthchecks(){
