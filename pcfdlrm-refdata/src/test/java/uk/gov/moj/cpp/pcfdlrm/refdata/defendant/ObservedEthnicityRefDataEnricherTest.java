...
class ObservedEthnicityRefDataEnricherTest {
    ...
    @Test
    void testShouldPopulateObservedEthnicityWhenEthnicityFound() {
    ...
    @Test
    void testShouldPopulateObservedEthnicityWhenEthnicityFoundMultiData() {
        when(referenceDataQueryService.retrieveObservedEthnicity()).thenReturn(getMockObservedEthnicityRefData());
    ...
    @Test
    void testShouldNotPopulateObservedEthnicityWhenEthnicityIsNull() {
