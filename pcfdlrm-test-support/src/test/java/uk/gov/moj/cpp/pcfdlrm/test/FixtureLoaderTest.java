...
class FixtureLoaderTest {
    ...
    /** ADR-001 - fixtures are decoded as UTF-8, so non-ASCII content survives the load. */
    @Test
    @DisplayName("reads a fixture as UTF-8")
    ...
    @Test
    @DisplayName("fails when a supplied parameter appears nowhere in the fixture")
    ...
    /** ADR-001's FR1 guard - an unbound {@code {{SOURCE_SYSTEM}}} must not pass. */
    @Test
    @DisplayName("fails when a placeholder is left unresolved")
