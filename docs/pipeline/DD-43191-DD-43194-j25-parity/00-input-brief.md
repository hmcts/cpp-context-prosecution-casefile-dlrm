...
Sibling story in the other repo: [DD-43192](https://github.com/hmcts/cpp-context-stagingdlrm/blob/team/25.104.x/docs/pipeline/DD-43191-DD-43192-j25-parity/00-input-brief.md).
...
**Bucket A for this repo — 7 items** (full matrix and evidence in the parity-method ADR):
...
framework-tier (Bucket B) — record a check, don't write a test. The parity-method ADR's **DLRM-01** (Function App Jackson parse behaviour) is stagingDLRM-only and does not apply here.
