...
> is [DD-43192](https://github.com/hmcts/cpp-context-stagingdlrm/blob/team/25.104.x/docs/pipeline/DD-43191-DD-43192-j25-upgrade/01-requirements.md).
> Mechanics are fixed by [the upgrade-mechanics ADR](../adrs/DD-43191-j25-upgrade-mechanics.md),
...
| Depends on | **[DD-43194 parity stage](../DD-43191-DD-43194-j25-parity/00-input-brief.md) merged to `team/25.104.x`** — hard, see FR1. Plus [the upgrade-mechanics ADR](../adrs/DD-43191-j25-upgrade-mechanics.md) accepted |
| Sibling story | [DD-43192](https://github.com/hmcts/cpp-context-stagingdlrm/blob/team/25.104.x/docs/pipeline/DD-43191-DD-43192-j25-upgrade/00-input-brief.md) — same stage in stagingDLRM, independently deliverable |
...
stale and must not be copied (the upgrade-mechanics ADR decision 2).
